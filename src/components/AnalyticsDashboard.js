...
export default function AnalyticsDashboard({ profileId = 'profile_1', userId = 'user_1' }) {
  ...
  const [viewsData] = useState([
    { date: 'Mon', views: 45, uniqueViews: 32 },
    { date: 'Tue', views: 52, uniqueViews: 38 },
    { date: 'Wed', views: 48, uniqueViews: 35 },
    { date: 'Thu', views: 61, uniqueViews: 42 },
    { date: 'Fri', views: 55, uniqueViews: 41 },
    { date: 'Sat', views: 67, uniqueViews: 48 },
    { date: 'Sun', views: 43, uniqueViews: 31 }
  ])
  const [deviceData] = useState([
    { name: 'Mobile', value: 1847, color: '#3B82F6' },
    { name: 'Desktop', value: 678, color: '#10B981' },
    { name: 'Tablet', value: 322, color: '#F59E0B' },
  ])
  const [locationData] = useState([
    { name: 'United States', value: 1247 },
    { name: 'United Kingdom', value: 432 },
    { name: 'Canada', value: 321 },
    { name: 'Australia', value: 287 },
    { name: 'Germany', value: 234 },
