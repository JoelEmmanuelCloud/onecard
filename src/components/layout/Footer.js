      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <a href="/" className="text-2xl font-light tracking-wide text-gray-900 mb-6 block">
              1necard
            </a>
            
            <p className="text-gray-600 mb-8 leading-relaxed max-w-sm font-light">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors duration-200"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-8 lg:col-span-3">
            {footerSections.map((section) => (
              <div key={section.title}>
                <h3 className="font-normal text-gray-900 mb-4">{section.title}</h3>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              <h3 className="font-normal text-gray-900 mb-1">Stay updated</h3>
              <p className="text-gray-600 text-sm font-light">Get product updates and news</p>
            </div>
            <div className="flex w-full md:w-auto max-w-sm">
              <input
                type="email"
                placeholder="Enter email"
                className="flex-1 px-4 py-2 border border-gray-200 rounded-l-full focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent text-sm font-light"
              />
              <button className="px-6 py-2 bg-gray-900 text-white rounded-r-full hover:bg-gray-800 transition-colors duration-200 text-sm font-light">
                Subscribe
              </button>
            </div>
          </div>
