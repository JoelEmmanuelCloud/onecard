...
export default function OptimizedMinimalPricing() {
  ...
  const getCardStyles = (color, index) => {
    const styles = {
      blue: {
        card: 'border-blue-200 bg-gradient-to-br from-white to-blue-50/50 hover:border-blue-300 hover:shadow-blue-100/50',
      ...
      purple: {
        card: 'border-purple-200 bg-gradient-to-br from-white to-purple-50/50 hover:border-purple-300 hover:shadow-purple-100/50 shadow-lg lg:scale-105 relative z-10',
      ...
      black: {
        card: 'border-gray-300 bg-gradient-to-br from-white to-gray-50/50 hover:border-gray-400 hover:shadow-gray-100/50',
        icon: 'bg-gray-100 text-gray-700',
        button: 'border-2 border-black hover:bg-black hover:text-white text-black',
        check: 'bg-black'
      }
    }
    return styles[color]
  ...
  return (
    <section id="pricing" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-gray-50/50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base sm:text-lg lg:text-xl text-black/70 max-w-3xl mx-auto font-normal leading-relaxed mb-6 sm:mb-8 lg:mb-10 px-4 sm:px-0">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center bg-white rounded-full p-1.5 border-2 border-gray-200 shadow-sm"
          >
            <button
              ...
              >
                ...
                <div className={`p-6 sm:p-8 lg:p-10 ${plan.popular ? 'pt-12 sm:pt-16 lg:pt-18' : ''}`}>
                  ...
                  <div className="text-center mb-6 sm:mb-8 lg:mb-10">
                    ...
                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-black mb-2 sm:mb-3">{plan.name}</h3>
                    <p className="text-black/70 text-sm sm:text-base font-medium mb-6 sm:mb-8">{plan.description}</p>
                    
                    {/* Pricing */}
                    <div className="mb-6 sm:mb-8">
                      {plan.price === 'Custom' ? (
                        <div className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-black">Custom</div>
                      ) : (
                        <div>
                          <div className="flex items-baseline justify-center mb-2">
                            <span className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-black">₦{plan.price.toLocaleString()}</span>
                            <span className="text-black/60 ml-2 text-sm sm:text-base font-medium">NGN</span>
                          </div>
                          <div className="text-xs sm:text-sm text-black/60 font-medium mb-4">One-time card purchase</div>
                          {plan.monthly && (
                            <div className="pt-4 border-t-2 border-black/10">
                              ...
                              <div className="text-xs sm:text-sm text-black/60 font-medium">for premium features</div>
                              {billingCycle === 'annual' && (
                  ...
                  <ul className="space-y-3 sm:space-y-4 mb-8 sm:mb-10">
                    {plan.features.map((feature, featureIndex) => (
                      ...
                      >
                        ...
                        <span className="text-black/90 text-sm sm:text-base font-medium leading-relaxed">{feature}</span>
                      </motion.li>
                    ))}
                  </ul>
        ...
        >
          <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl lg:rounded-3xl p-6 sm:p-8 lg:p-12 border-2 border-emerald-200/50 shadow-sm">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {trustIndicators.map((item, index) => (
                ...
                >
                  ...
                  <div className="text-lg sm:text-xl lg:text-2xl font-semibold text-emerald-700 group-hover:text-emerald-800 transition-colors">
                    {item.label}
                  </div>
                  <div className="text-xs sm:text-sm lg:text-base text-black/70 font-medium">
                    {item.sublabel}
                  </div>
                </motion.div>
              ))}
        ...
        >
          <div className="bg-white rounded-2xl lg:rounded-3xl p-6 sm:p-8 lg:p-12 border-2 border-gray-200 shadow-sm">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-black mb-3 sm:mb-4 lg:mb-6">
              Still have questions?
            </h3>
            <p className="text-black/70 mb-6 sm:mb-8 lg:mb-10 font-normal text-sm sm:text-base lg:text-lg px-4 sm:px-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md mx-auto sm:max-w-none">
              <button className="border-2 border-black text-black px-6 sm:px-8 py-3 sm:py-3.5 rounded-full hover:bg-black hover:text-white transition-all duration-300 font-medium text-sm sm:text-base shadow-sm hover:shadow-md touch-manipulation">
                View FAQ
              </button>
