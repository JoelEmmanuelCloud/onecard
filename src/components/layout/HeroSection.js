...
export default function OptimizedMinimalHero() {
  ...
  return (
    <>
      <section className="min-h-screen flex items-center bg-gradient-to-b from-white to-blue-50/30 pt-16 sm:pt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
            ...
            >
              <motion.h1
                ...
                className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-medium text-black leading-[1.15] sm:leading-tight mb-4 sm:mb-6"
              >
              ...
              <motion.p
                ...
                className="text-base sm:text-lg lg:text-xl text-black/70 mb-6 sm:mb-8 max-w-xl mx-auto lg:mx-0 font-normal leading-relaxed"
              >
              ...
              >
                ...
                <motion.button 
                  ...
                  className="border-2 border-black text-black px-6 sm:px-8 py-3 sm:py-3.5 rounded-full hover:bg-black hover:text-white transition-all duration-300 font-medium shadow-sm hover:shadow-md touch-manipulation text-sm sm:text-base"
                >
                  Learn More
                </motion.button>
              </motion.div>
              ...
              <motion.div
                ...
                className="flex items-center justify-center lg:justify-start space-x-6 sm:space-x-8 text-xs sm:text-sm text-black/60 font-medium"
              >
