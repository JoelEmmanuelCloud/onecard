    ...
    <section id="features" className="py-16 sm:py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-black/80 max-w-2xl mx-auto font-medium">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
          {features.map((feature, index) => {
            ...
            const colors = [
              ...
              'bg-rose-100 text-rose-700 group-hover:bg-rose-600',
              'bg-black/10 text-black group-hover:bg-black'
            ]
            ...
            return (
              ...
              >
                ...
                <p className="text-black/80 leading-relaxed font-medium text-sm sm:text-base">
                  {feature.description}
                </p>
              </motion.div>
            )
        ...
        >
          <div className="max-w-sm mx-auto">
            ...
            <p className="text-black/80 mb-6 sm:mb-8 font-medium text-sm sm:text-base">
              Experience how simple professional networking can be
            </p>
            
            <div className="bg-white rounded-2xl p-6 sm:p-8 border-2 border-black/20 shadow-sm">
              <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 bg-black/5 rounded-full flex items-center justify-center shadow-sm border border-black/10">
                <Smartphone className="w-7 h-7 sm:w-8 sm:h-8 text-black" />
              </div>
              <h4 className="font-semibold text-black mb-2 text-sm sm:text-base">Interactive Preview</h4>
              <p className="text-black/80 mb-4 sm:mb-6 text-xs sm:text-sm font-medium">Try a live demo of your digital profile</p>
              <button className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-2.5 sm:py-3 rounded-full hover:from-blue-700 hover:to-blue-800 transition-colors duration-200 font-medium text-sm sm:text-base w-full sm:w-auto">
                Try Demo
              </button>
            </div>
          </div>
