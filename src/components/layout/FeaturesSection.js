...
export default function OptimizedMinimalFeatures() {
  ...
  return (
    <section id="features" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-white to-gray-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-black mb-4 sm:mb-6 leading-tight">
            ...
            <span className="block text-blue-600">connect professionally</span>
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-black/70 max-w-3xl mx-auto font-normal leading-relaxed px-4 sm:px-0">
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`group p-6 sm:p-8 lg:p-10 rounded-2xl lg:rounded-3xl border-2 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg ${colors.bg} ${colors.border} ${colors.hoverBorder} touch-manipulation`}
              >
                <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
                  <div className={`w-16 h-16 sm:w-18 sm:h-18 lg:w-20 lg:h-20 ${colors.icon} rounded-2xl flex items-center justify-center flex-shrink-0 mx-auto sm:mx-0 group-hover:scale-105 transition-transform duration-300 shadow-sm`}>
                    <img 
                      src={feature.icon} 
                      alt=""
                  ...
                  <div className="text-center sm:text-left flex-1">
                    <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-black mb-3 sm:mb-4 leading-tight">
                      {feature.title}
                    </h3>
                    
                    <p className="text-black/70 leading-relaxed font-normal text-sm sm:text-base lg:text-lg">
                      {feature.description}
                    </p>
                  </div>
                </div>
        ...
        >
          <div className="mb-8 sm:mb-12 lg:mb-16">
            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-black mb-3 sm:mb-4 lg:mb-6">
              Choose your perfect design
            </h3>
            <p className="text-sm sm:text-base lg:text-lg text-black/70 font-normal px-4 sm:px-0 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto">
            {cardImages.map((card, index) => (
              ...
              >
                <div className={`relative rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden bg-white border-2 border-gray-200 hover:border-blue-300 shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 ${selectedCard === index ? 'ring-4 ring-blue-500/20 border-blue-400 -translate-y-2 shadow-lg' : ''}`}>
          ...
          >
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl lg:rounded-3xl p-6 sm:p-8 lg:p-12 border-2 border-blue-100 max-w-2xl mx-auto">
              <h4 className="text-lg sm:text-xl lg:text-2xl font-semibold text-black mb-3 sm:mb-4">
                Ready to get started?
              </h4>
              <p className="text-black/70 mb-6 sm:mb-8 text-sm sm:text-base px-4 sm:px-0">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                ...
                <button className="border-2 border-black text-black px-6 sm:px-8 py-3 sm:py-3.5 rounded-full hover:bg-black hover:text-white transition-all duration-300 font-medium text-sm sm:text-base touch-manipulation">
                  View Pricing
                </button>
              </div>
            </div>
